	...
	return (
		<>
			<SidebarWrapper>
				...
				{!isSend && (
					<Scrollable className="h-[calc(100%-130px)] md:h-[calc(100%-110px)] py-[35px] md:px-4 gap-[35px]">
						<div>
						...
						<div>
							...
							<div className="px-4 text-sm text-gray mt-[9px]">
								Enter a few words so the sender can be sure that
								you received the code.
							</div>
						</div>
